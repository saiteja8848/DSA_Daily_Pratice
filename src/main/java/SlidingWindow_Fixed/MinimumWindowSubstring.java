...
public String minWindow(String s, String t) {
        ...
        //substring = [B-1,A-1,N-1,C-1] and t = [A-1,B-1,C-1] so t is present in substring
        ...
        while(endPtr<s.length()){
            ...
            //so if we hit this condition means, we have a substring with us which is covering t
            // now we have to check, can we make it even smaller length -> which is still matching t
